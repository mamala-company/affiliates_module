...
abstract class BaseController extends Extendable
{
    ...
    /**
     * @var object Reference the logged in user.
     */
    protected $user;

    /**
     * @var the module of the current user
     */
    protected $module;
    ...
    /**
     * @var html code of the navigation items
     */
    public $nav;
    ...
    public function __construct()
    {
         ...
         */
        $this->layout = $this->layout ?: 'program';
        $this->layoutPath = '~/modules/affiliates/layouts';
    ...
    public function run($action = null, $params = [])
    {
        ...
        if (!$isPublicAction) {
            ...
            if (!Auth::check()) {
                return Request::ajax()
                    ...
                    : Helper::redirect('affiliates/login');
            }
        }
         ...
         * Extensibility
         */
        if ($event = $this->fireSystemEvent('bbf.page.beforeDisplay', [$action, $params])) {
            return $event;
        }
    ...
    public function onLogout()
    {
        ...
        $url = post('redirect', Url::to('/'));

        Flash::success(Lang::get('bbf::lang.session.logout'));
